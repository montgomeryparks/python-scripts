...
'''
    ...
    ,[AGRESERVE] VARCHAR(8000)
    ,[AGRESERVE_DOMINANT] VARCHAR(8000)
    ,[AGRESERVE_AREAS] VARCHAR(8000)
    ...
    ,[GEOM_LOCATION_CODE] VARCHAR(8000)
    ,[GEOM_LOCATION_CODE_DOMINANT] VARCHAR(8000)
    ,[GEOM_LOCATION_CODE_AREAS] VARCHAR(8000)
    ,[GEOM_LOCATION_CODE_NEAREST] VARCHAR(8000)
    ,[GEOM_LOCATION_CODE_NEARESTDISTANCE] FLOAT
    ,[GEOM_LOCATION_CODE_NEARESTAREAS] VARCHAR(8000)
    ,[GEOM_BUILDING_CODE] VARCHAR(8000)
    ,[GEOM_BUILDING_CODE_DOMINANT] VARCHAR(8000)
...
'''
    ...
    ,CAST([AGRESERVE] AS VARCHAR(1020)) AS [AGRESERVE]
    ,CAST([AGRESERVE_DOMINANT] AS VARCHAR(255)) AS [AGRESERVE_DOMINANT]
    ,CAST([AGRESERVE_AREAS] AS VARCHAR(MAX)) AS [AGRESERVE_AREAS]
    ...
    ,ROUND([GEOM_PARK_CODE_NEARESTDISTANCE], 4) AS [GEOM_PARK_CODE_NEARESTDISTANCE]
    ,CAST([GEOM_PARK_CODE_NEARESTAREAS] AS VARCHAR(MAX)) AS [GEOM_PARK_CODE_NEARESTAREAS]
    ,CAST([GEOM_LOCATION_CODE] AS VARCHAR(150)) AS [GEOM_LOCATION_CODE]
    ,CAST([GEOM_LOCATION_CODE_DOMINANT] AS VARCHAR(30)) AS [GEOM_LOCATION_CODE_DOMINANT]
    ,CAST([GEOM_LOCATION_CODE_AREAS] AS VARCHAR(MAX)) AS [GEOM_LOCATION_CODE_AREAS]
    ,CAST([GEOM_LOCATION_CODE_NEAREST] AS VARCHAR(30)) AS [GEOM_LOCATION_CODE_NEAREST]
    ,ROUND([GEOM_LOCATION_CODE_NEARESTDISTANCE], 4) AS [GEOM_LOCATION_CODE_NEARESTDISTANCE]
    ,CAST([GEOM_LOCATION_CODE_NEARESTAREAS] AS VARCHAR(MAX)) AS [GEOM_LOCATION_CODE_NEARESTAREAS]
    ,CAST([GEOM_BUILDING_CODE] AS VARCHAR(150)) AS [GEOM_BUILDING_CODE]
    ,CAST([GEOM_BUILDING_CODE_DOMINANT] AS VARCHAR(30)) AS [GEOM_BUILDING_CODE_DOMINANT]
